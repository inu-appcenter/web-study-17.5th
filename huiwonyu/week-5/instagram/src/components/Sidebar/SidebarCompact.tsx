...
export default function SidebarExpanded() {
  return (
    ...
    >
      {/* 상단 로고 */}
      <div className="flex items-center h-18 mb-4 px-2">
        <Link to="/">
          <img src={LogoCompact} alt="Instagram" className="h-7 cursor-pointer" />
        </Link>
      </div>
      ...
      <nav className="flex-1 flex flex-col gap-3">
          ...
          if (to) {
            return (
              <NavLink
                ...
                className={({ isActive }) =>
                  [
                    "flex items-center justify-center rounded-xl w-12 h-12 transition-colors",
            ...
            return (
              <div
                key={label}
                className="flex items-center justify-center rounded-xl w-12 h-12 transition-colors hover:bg-gray-100 cursor-pointer"
              >
                <div className="flex items-center justify-center w-6 h-6">
        ...
        <NavLink
          ...
          className={({ isActive }) =>
            [
              "flex items-center justify-center rounded-full w-12 h-12 transition-colors",
              isActive ? "hover:bg-gray-100" : "hover:bg-gray-100",
            ].join(" ")
          }
        >
